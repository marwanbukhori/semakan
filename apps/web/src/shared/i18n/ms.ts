...
export const ms: Translation = {
  ...
  about: {
    ...
    aiWorkflow: {
      title: 'Aliran kerja AI',
      pipeline: 'Cara ia dibina',
      tools: 'Alatan',
      ownership: 'Siapa buat apa',
      own: 'Apa yang saya miliki',
      ai: 'Apa yang AI lakukan',
      caught: 'Ditangkap oleh semakan',
      numbers: 'Mengikut angka',
      logs: 'Baca log',
      viewLog: 'Log semakan',
      viewCommit: 'Commit {{sha}}',
      tasks: 'Tugasan selesai',
      fixRounds: 'Pusingan pembetulan',
      rulings: 'Ruling direkodkan',
      plan: 'Pelan {{n}}',
      total: 'Jumlah',
    },
  },
