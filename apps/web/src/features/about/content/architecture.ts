  ...
  layers: [
    {
      ...
      paths: [
        ...
        'apps/web/src/features/applications/routes/ListRoute.tsx',
      ],
    },
    {
      ...
      paths: [
        'apps/web/src/features/applications/api/queries.ts',
        'apps/web/src/features/applications/api/mutations.ts',
        'apps/web/src/features/applications/hooks/useApplicationFilters.ts',
      ],
    },
    {
    ...
    },
    {
      ...
      paths: [
        'apps/web/src/mocks/handlers/applications.ts',
        'apps/web/src/mocks/handlers/dataGov.ts',
      ],
    },
  ],
  diagramLabel: {
