...
conflicted with the plan, the spec or itself. They are published from
`.superpowers/sdd/<plan>/progress.md`, a working file that is not committed, with agent IDs and
local paths removed by `scripts/publish-review-logs.mjs`.
